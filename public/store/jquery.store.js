(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.cartPrefix = "Electronics-"; // Prefix string to be prepended to the cart's name in the session storage
		...
		handleAddToCartForm: function () {
			...
			self.$formAddToCart.each(function() {
				...
				$form.on("submit", function () {
					...
					boxeverAddToCart(name, price, qty);
				});
			});
		},
...
var postCode = sessionStorage.getItem("billing-zip");
			boxeverConfirmOrder(fname, lname, email, city, street, postCode);
		}
	};
